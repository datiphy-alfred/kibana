...
import 'plugins/kibana/my_discover/saved_searches/_saved_search';
import 'ui/notify';
import uiModules from 'ui/modules';


const module = uiModules.get('my_discover/saved_searches', [
  'kibana/notify'
]);
...
module.service('savedSearches', function (Promise, config, kbnIndex, es, createNotifier, SavedSearch, kbnUrl) {
  ...
  this.urlFor = function (id) {
    return kbnUrl.eval('#/my_discover/{{id}}', {id: id});
  };
