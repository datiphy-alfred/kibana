...
import 'plugins/kibana/my_discover/components/field_chooser/discover_field';
import _ from 'lodash';
import $ from 'jquery';
import rison from 'rison-node';
import fieldCalculator from 'plugins/kibana/my_discover/components/field_chooser/lib/field_calculator';
import IndexPatternsFieldListProvider from 'ui/index_patterns/_field_list';
import uiModules from 'ui/modules';
import fieldChooserTemplate from 'plugins/kibana/my_discover/components/field_chooser/field_chooser.html';
const app = uiModules.get('apps/my_discover');



app.directive('myDiscFieldChooser', function ($location, globalState, config, $route, Private) {
