import $ from 'jquery';
import html from 'plugins/kibana/my_discover/components/field_chooser/discover_field.html';
import _ from 'lodash';
import 'ui/directives/css_truncate';
import 'ui/directives/field_name';
import detailsHtml from 'plugins/kibana/my_discover/components/field_chooser/lib/detail_views/string.html';
import uiModules from 'ui/modules';
const app = uiModules.get('apps/my_discover');



app.directive('myDiscoverField', function ($compile) {
  return {
    restrict: 'E',
    template: html,
    replace: true,
