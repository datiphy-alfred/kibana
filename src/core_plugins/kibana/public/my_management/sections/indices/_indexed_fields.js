...
import nameHtml  from 'plugins/kibana/my_management/sections/indices/_field_name.html';
import aliasHtml from 'plugins/kibana/my_management/sections/indices/_field_alias.html';
import typeHtml  from 'plugins/kibana/my_management/sections/indices/_field_type.html';

import controlsHtml          from 'plugins/kibana/my_management/sections/indices/_field_controls.html';
import indexedFieldsTemplate from 'plugins/kibana/my_management/sections/indices/_indexed_fields.html';

uiModules.get('apps/my_management')
.directive('myIndexedFields', function ($filter) {
  ...
  return {
    ...
    link: function ($scope) {
      ...
      $scope.columns = [
        { title: 'name' },
        { title: 'alias', info: 'These fields allow for an alias for the field name' },
        { title: 'type' },
        { title: 'format' },
